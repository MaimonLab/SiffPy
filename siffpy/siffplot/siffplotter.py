...
class SiffPlotter():
    ...
    def __init__(self, siffreader : SiffReader, *args, **kwargs):
        ...
        if 'use_napari' in kwargs:
            if kwargs['use_napari'] and NAPARI: # make sure it's importable
                self.use_napari = True
...
### ROI
    ...
    def draw_rois_napari(self,**kwargs):
        """
        ...
        """
        viewer = napari.Viewer(title='Annotate ROIs')
