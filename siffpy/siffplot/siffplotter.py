...
This is a BASE class, meaning it's basically never invoked
...
class SiffPlotter(ABC):
    ...
    def __init__(self, siffreader : SiffReader, *args, opts : Dict = {}, **kwargs):
        f"""
        ...
        if opts:
            self._local_opts = {**self._local_opts, **opts}
        else:
    ...
    @property
    def local_opts(self)->dict:
        return self._local_opts

    @local_opts.setter
    def local_opts(self, opts) -> None:
        self._local_opts = opts

    def add_opts(self, opts_dict : dict)->None:
        """
        Adds options to the local_opts dict for this plotter.

        Passed argument must be a dict. Might adjust this for
        more flexible structure in the future.
        """
        self._local_opts = {**self._local_opts, **opts_dict}
